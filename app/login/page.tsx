...
export default function login() {
    ...
    const onSubmit = async () => {
        await postAction(userID, password, router, setIsLogin, setErrorMessage);
    }
    return(
        <Box 
            display='flex' 
            ...
            >
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Box 
                        ...
                        padding="8%"
                    >
                        <Text fontSize="2xl" as="b" marginBottom="5%">ログインする</Text>
                        {!isLogin && <Text color="red">{errorMessage}</Text>}
                        ...
                        <Button type="submit" width="20%" margin="2%">ログイン</Button>
                    </Box>
                </form>
            </Box>
      </Box>
